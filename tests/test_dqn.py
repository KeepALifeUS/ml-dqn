"""
Comprehensive tests для DQN implementation.
...
class TestQNetwork:
    """Test Q-Network архитектуры."""
    
    def test_qnetwork_creation(self):
        """Тест создания Q-Network."""
...
class TestPerformanceMetrics:
    ...
    def test_financial_metrics(self):
        """Тест финансовых метрик."""
        metrics = PerformanceMetrics()
        
        # Add episodes с returns
